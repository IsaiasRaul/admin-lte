...
class FormularioSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>1, 'id_etapa_producto'=>1, 'label'=>'1. Nombre de quien responde', 'name'=>'nombre_quien_responde', 'pattern'=>'Nombre de quien responde', 'requerido'=>'required', 'orden'=>1, 'activo' =>1]);
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>1, 'id_etapa_producto'=>1, 'label'=>'2. Cargo', 'name'=>'cargo', 'pattern'=>'Cargo', 'requerido'=>'required', 'orden'=>2, 'activo' =>1]);
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>7, 'id_etapa_producto'=>1, 'label'=>'3 .Correo electrónico institucional', 'name'=>'correo_electronico_institucional', 'pattern'=>'Correo electrónico institucional', 'requerido'=>'required', 'orden'=>3, 'activo' =>1]);
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>10,'id_etapa_producto'=>1,'label'=>'4. Teléfono de contacto', 'name'=>'telefono_contacto', 'pattern'=>'Teléfono de contacto', 'requerido'=>'required', 'orden'=>4, 'activo' =>1]);
        ...
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>10, 'id_etapa_producto'=>2, 'label'=>'5. N° TOTAL DE PROCESOS DE SELECCIÓN para contratas, código del trabajo y/o concursos de planta desarrollados durante el periodo enero - diciembre 2022', 'name'=>'total_procesos_seleccion', 'pattern'=>'Número total de procesos de selección para contratas, código del trabajo y/o concursos de planta desarrollados durante el periodo enero - diciembre 2022', 'requerido'=>'required', 'orden'=>6, 'activo' =>1]);
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>10, 'id_etapa_producto'=>2, 'label'=>'6. N° TOTAL DE POSTULANTES en procesos de selección para contratas, código del trabajo y/o concursos de planta desarrollados durante el periodo enero - diciembre 2022', 'name'=>'total_postulantes', 'pattern'=>'Número total de postulantes en proceso de selección para contratas', 'requerido'=>'required', 'orden'=>7, 'activo' =>1]);
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>10, 'id_etapa_producto'=>2, 'label'=>'7. N° TOTAL DE POSTULANTES CON DISCAPACIDAD Y/O ASIGNATARIOS/AS DE PENSIÓN DE INVALIDEZ en procesos de selección para contratas, código del trabajo y/o concursos de planta durante el periodo enero - diciembre 2022', 'name'=>'total_postulantes_discapacidad', 'pattern'=>'Número total de postulantes con discapacidad', 'requerido'=>'required', 'orden'=>8, 'activo' =>1]);
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>10, 'id_etapa_producto'=>2, 'label'=>'8. N° TOTAL DE POSTULANTES CON DISCAPACIDAD Y/O ASIGNATARIOS/AS DE PENSIÓN DE INVALIDEZ QUE FUERON PARTE DE UNA NÓMINA DE FINALISTAS en procesos de selección y/o concursos desarrollados durante el periodo enero - diciembre 2022', 'name'=>'total_postulantes_discapacidad_pension', 'pattern'=>'Número total de postulantes con discapacidad y/o asignatarios de pensión de invalidez', 'requerido'=>'required', 'orden'=>9, 'activo' =>1]);
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>10, 'id_etapa_producto'=>2, 'label'=>'9. N° TOTAL DE PERSONAS CON DISCAPACIDAD Y/O ASIGNATARIOS/AS DE PENSIÓN DE INVALIDEZ QUE FUERON SELECCIONADAS durante el periodo enero - diciembre 2022', 'name'=>'total_personas_disc_invalidez_seleccionadas', 'pattern'=>'Número total de personas con discapacidad y/o asignatarias de pensión de invalidez que hayan sido seleccionada', 'requerido'=>'required', 'orden'=>10, 'activo' =>1]);
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>5, 'id_etapa_producto' =>2, 'label'=>'10. En caso de no haber seleccionado a todas las personas con discapacidad y/o asignatarias de pensión de invalidez que fueron parte de nóminas ﬁnales en el año 2022, indicar el motivo. [Selecciona todos los que corresponda]', 'name'=>'motivo_no_seleccion', 'pattern'=>'En caso de no haber seleccionado a todas las personas con discapacidad y/o asignatarias de pensión de invalidez que fueron parte de nóminas ﬁnales en el año 2022, indicar el motivo.', 'requerido'=>'required', 'orden'=>11, 'activo' =>1]);
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>2, 'id_etapa_producto' =>2, 'label'=>'11. Si tiene algún comentario respecto a la selección preferente señalar a continuación', 'name'=>'comentarios_seleccion_preferente','pattern'=>'Tiene algún comentario respecto a la selección preferente', 'requerido'=>'required', 'orden'=>12, 'activo' =>1]);
        ...
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>10, 'id_etapa_producto'=>4, 'label'=>'15. Indique dotación máxima para el año 2022', 'name'=>'dotacion_maxima', 'pattern'=>'Indique dotación máxima para el año 2022', 'requerido'=>'required', 'orden'=>18, 'activo' =>1]);
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>3,  'id_etapa_producto'=>4, 'label'=>'16. De acuerdo a lo señalado anteriormente ¿hubo personas con discapacidad y/o asignatarias de pensión de invalidez con contrato vigente en el 2022?', 'name'=>'personas_discapacidad_contrato_vigente', 'pattern'=>'De acuerdo a lo señalado anteriormente ¿hubo personas con discapacidad y/o asignatarias de pensión de invalidez con contrato vigente en el 2022?', 'requerido'=>'required', 'orden'=>19, 'activo' =>1]);
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>11, 'id_etapa_producto'=>4, 'label'=>'17. Detalle de personas con discapacidad y/o asignatarias de pensión de invalidez', 'name'=>'detalle_personas_discapacidad', 'pattern'=>'Detalle de personas con discapacidad y/o asignatarias de pensión de invalidez', 'requerido'=>'required', 'orden'=>20, 'activo' =>1]);
        Formularios::create(['id_producto' => 1, 'id_tipo_input'=>2,  'id_etapa_producto'=>4, 'label'=>'18. Si tiene algún comentario respecto respecto a la mantención y contratación, lo puede señalar a continuación', 'name'=>'comentario_mantencion_contratacion','pattern'=>'Tiene algún comentario respecto a la mantención y contratación, lo puede señalar a continuación', 'requerido'=>'required', 'orden'=>21, 'activo' =>1]);
